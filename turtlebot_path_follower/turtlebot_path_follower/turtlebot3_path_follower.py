...
class TurtleBotPathFollower(Node):
    def __init__(self):
        ...
        self.path_file = '/media/rahulk99/New Volume/UMD/2. Spring_25/ENPM661_Planning/Projects/Project3_hardware/Planning_Project/Project3_Hardware/tb4/TB4_Hardware/src/turtlebot_path_follower/data/final_path.txt'
...
#         self.canvas_height = 3.0
#         # Subscriber
#         self.create_subscription(Odometry, '/tb4_2/odom', self.odom_callback, 10)
#         # self.create_subscription(Odometry, '/odom', self.odom_callback, 10)
#         # Publisher
#         # self.cmd_vel_pub = self.create_publisher(Twist, '/cmd_vel', 10)
#         self.cmd_vel_pub = self.create_publisher(TwistStamped, '/tb4_2/cmd_vel', 10)
...
#         # Rotation threshold
#         if abs(angle_diff) > 0.1:
#             ts.twist.angular.z = 0.8 * angle_diff
#         else:
#             ts.twist.linear.x = 0.4
#             ts.twist.angular.z = 0.2 * angle_diff
